...
public class TopDriverActivity extends AppCompatActivity {
    public static final int LAUNCH_ADD_ACTIVITY = 123;
    private SwipeRefreshLayout srTopDriver;
    private TopDriverAdapter adapter;
    private ApiInterface apiService;
    private SearchView svTopDriver;
    private LinearLayout layoutLoading;
    private Button btnTopDriver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        srTopDriver = findViewById(R.id.sr_top_driver);
        svTopDriver = findViewById(R.id.sv_top_driver);
        btnTopDriver = findViewById(R.id.btn_top_driver);
        srTopDriver.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                getAllTransaksi();
            }
        });
        svTopDriver.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        RecyclerView rvTopDriver = findViewById(R.id.rv_top_driver);
        adapter = new TopDriverAdapter(new ArrayList<>(), this);
        rvTopDriver.setLayoutManager(new LinearLayoutManager(TopDriverActivity.this,
                LinearLayoutManager.VERTICAL, false));
        rvTopDriver.setAdapter(adapter);
        getAllTransaksi();
    }
    @Override
    ...
    private void getAllTransaksi() {
        ...
        Call<TransaksiResponse> call = apiService.getTopDriver("Bearer "+getToken);
        srTopDriver.setRefreshing(true);
        call.enqueue(new Callback<TransaksiResponse>() {
            ...
            public void onResponse(Call<TransaksiResponse> call,
                ...
                if (response.isSuccessful()) {
                    ...
                    adapter.getFilter().filter(svTopDriver.getQuery());
                    ...
                    try {
                        ...
                        Toast.makeText(TopDriverActivity.this,
                ...
                srTopDriver.setRefreshing(false);
            }
            @Override
            public void onFailure(Call<TransaksiResponse> call, Throwable t) {
                Toast.makeText(TopDriverActivity.this, t.getMessage(),
                        Toast.LENGTH_SHORT).show();
                srTopDriver.setRefreshing(false);
            }
        });
 ...
 * */
        ...
        String pdfName = "Laporan Top 5 Driver" + ".pdf";
        ...
        com.itextpdf.text.Font f = new
                ...
                com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 10,
                com.itextpdf.text.Font.NORMAL, BaseColor.BLACK);
        Paragraph Pembuka = new Paragraph("\nBerikut merupakan daftar 5 Top Driver: \n\n", f);
