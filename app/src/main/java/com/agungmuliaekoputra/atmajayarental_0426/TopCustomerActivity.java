...
import com.agungmuliaekoputra.atmajayarental_0426.adapters.TopCustomerAdapter;
import com.agungmuliaekoputra.atmajayarental_0426.adapters.TopDriverAdapter;
...
public class TopCustomerActivity extends AppCompatActivity {
    ...
    private SwipeRefreshLayout srTopCustomer;
    private TopCustomerAdapter adapter;
    private ApiInterface apiService;
    private SearchView svTopCustomer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        srTopCustomer = findViewById(R.id.sr_top_customer);
        svTopCustomer = findViewById(R.id.sv_top_customer);
        btnTopCustomer = findViewById(R.id.btn_top_customer);
        srTopCustomer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                getAllTransaksi();
            }
        });
        svTopCustomer.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        RecyclerView rvTopCustomer = findViewById(R.id.rv_top_customer);
        adapter = new TopCustomerAdapter(new ArrayList<>(), this);
        rvTopCustomer.setLayoutManager(new LinearLayoutManager(TopCustomerActivity.this,
                LinearLayoutManager.VERTICAL, false));
        rvTopCustomer.setAdapter(adapter);
        getAllTransaksi();
    }
    @Override
    ...
    private void getAllTransaksi() {
        ...
        Call<TransaksiResponse> call = apiService.getTopCustomer("Bearer "+getToken);
        srTopCustomer.setRefreshing(true);
        call.enqueue(new Callback<TransaksiResponse>() {
            ...
            public void onResponse(Call<TransaksiResponse> call,
                ...
                if (response.isSuccessful()) {
                    ...
                    adapter.getFilter().filter(svTopCustomer.getQuery());
                    ...
                    try {
                        ...
                        Toast.makeText(TopCustomerActivity.this,
                ...
                srTopCustomer.setRefreshing(false);
            }
            @Override
            public void onFailure(Call<TransaksiResponse> call, Throwable t) {
                Toast.makeText(TopCustomerActivity.this, "Network error",
                        Toast.LENGTH_SHORT).show();
                srTopCustomer.setRefreshing(false);
            }
        });
 ...
 * */
        ...
        String pdfName = "Laporan Top 5 Customer" + ".pdf";
        ...
        com.itextpdf.text.Font f = new
                ...
                com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 10,
                com.itextpdf.text.Font.NORMAL, BaseColor.BLACK);
        Paragraph Pembuka = new Paragraph("\nBerikut merupakan daftar Top 5 Customer: \n\n", f);
        ...
        PdfPCell h3 = new PdfPCell(new Phrase("Alamat Customer"));
        ...
        for (Transaksi T : transz) {
            ...
            tableData.addCell(T.getALAMAT_CUSTOMER());
        }
