...
public class TopDriverAdapter extends
        RecyclerView.Adapter<TopDriverAdapter.ViewHolder>
        implements Filterable {
    private List<Transaksi>transaksiList, filteredTransaksiList;
    private Context context;
    public TopDriverAdapter(List<Transaksi> transaksiList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_top_driver, parent, false);
